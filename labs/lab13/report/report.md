...
что $RANDOM выдаёт псевдослучайные числа в диапазоне от 0 до 32767.
=======
Если задан параметр существует архив с данным названием, то выводится справка. Если параметр не задан или архива не существует, выводится сообщение об ошибке (рис. @fig:004).
...
>>>>>>> 81413be1ad12733d13df596f4a8fa388a8476ea7
